...
namespace EFDatabaseFirst
{
    ...
    internal static class ConfigManager
    {
        ...
        public static void GenerateInitialConfig()
        {
            ...
            _config = new Dictionary<string, string>();
            _config.Add("Server", "SERVER_NAME_HERE");
            _config.Add("Database", "DATABASE_NAME_HERE");
            _config.Add("TrustedConnection", "TRUSTED_CONNECTION_BOOL_HERE");
            _config.Add("TrustServerCertificate", "TRUST_SERVER_CERTIFICATE_BOOL_HERE");
